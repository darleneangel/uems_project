...
class SubjectLoadView extends StatelessWidget {
  ...
  const SubjectLoadView({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSubjectCard("Introduction to Computer Science", "CS-101", "3:00 PM - 5:00 PM", "MWF"),
              const SizedBox(height: 12),
              _buildSubjectCard("Data Structures", "CS-102", "10:00 AM - 12:00 PM", "TTh"),
              const SizedBox(height: 12),
              _buildSubjectCard("Web Development", "CS-103", "1:00 PM - 3:00 PM", "MWF"),
            ],
          ),
        ),
      ),
  ...
  Widget _buildSubjectCard(String subject, String code, String time, String days) {
    return ClipRRect(
